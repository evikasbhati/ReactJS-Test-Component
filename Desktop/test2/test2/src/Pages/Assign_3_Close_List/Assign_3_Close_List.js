...
import './Assign_3_Close_List.css'
...
const Assign_3_Close_List=()=>{
    ...
    useEffect(()=>{
        const getOwner=async()=>{
            try{
                const res=await axios.get('https://testapi.buopso.com/lms/owners')
    ...
    useEffect(()=>{
        const getSource=async()=>{
            try{
                const res=await axios.get('https://testapi.buopso.com/lms/sources')
   ...
   useEffect(()=>{
       const getStage=async()=>{
           try{
               const res=await axios.get('https://testapi.buopso.com/lms/stages')
